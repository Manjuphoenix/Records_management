...
class Mytable(models.Model):
    ...
    editor = models.CharField(max_length=250, blank=True, null=True)
    ...
    abstarct = models.TextField(blank=True, null=True)
    loaction = models.CharField(max_length=200, blank=True, null=True)
    ref = models.TextField(blank=True, null=True)
    ref1 = models.TextField(blank=True, null=True)
...
class RecordAppMytable(models.Model):
